                  ...
                  child: Center(
                    child: Column(
                      ...
                      children: [
                        ...
                        SizedBox(height: 8),
                        Row(children: [
                          Expanded(child: TitleText(text: '7. Transfer of Data', align: TextAlign.start))
                        ]),
                        Text(
                            '\nYour information, including Personal Data, may be transferred to – and maintained on – computers located outside of your state, province, country or other governmental jurisdiction where the data protection laws may differ from those of your jurisdiction.If you are located outside India and choose to provide information to us, please note that we transfer the data, including Personal Data, to India and process it there.Your consent to this Privacy Policy followed by your submission of such information represents your agreement to that transfer.VVG Innovators will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.'),
                        SizedBox(height: 8),
                        Row(children: [
                          Expanded(child: TitleText(text: '8. Disclosure of Data', align: TextAlign.start))
                        ]),
                        Text(
                        ...
                        Row(
                          children: [
                            Expanded(
                              child: TitleText(text: '13. Analytics', align: TextAlign.start),
                            ),
                          ],
                        ),
                        Text(
                        ...
                        Row(
                          children: [
                            Expanded(
                              child: TitleText(text: '14. CI/CD tools', align: TextAlign.start),
                            ),
                          ],
                        ),
                        Text(
                        ...
                        Row(
                          children: [
                            Expanded(
                              child: TitleText(text: '15. Advertising', align: TextAlign.start),
                            ),
                          ],
                        ),
                        Text(
                        ...
                        Row(
                          children: [
                            Expanded(
                              child: TitleText(text: '16. Behavioral Remarketing', align: TextAlign.start),
                            ),
                          ],
                        ),
                        Text(
                        ...
                        Row(
                          children: [
                            Expanded(
                              child: TitleText(text: '17. Payments', align: TextAlign.start),
                            ),
                          ],
                        ),
                        Text(
                        ...
                        Row(
                          children: [
                            Expanded(
                              child: TitleText(text: '18. Links to Other Sites', align: TextAlign.start),
                            ),
                          ],
                        ),
                        Text(
                        ...
                        Row(
                          children: [
                            Expanded(
                              child: TitleText(text: '19. Children’s Privacy', align: TextAlign.start),
                            ),
                          ],
                        ),
                        Text(
                        ...
                        Row(
                          children: [
                            Expanded(
                              child: TitleText(text: '20. Changes to This Privacy Policy', align: TextAlign.start),
                            ),
                          ],
                        ),
                        Text(
                        ...
                        SizedBox(height: 8),
                        Row(children: [Expanded(child: TitleText(text: '21. Contact Us', align: TextAlign.start))]),
                        Text(
                            '\nIf you have any questions about this Privacy Policy, please contact us by email: support@khelbuddy.com.'),
                      ],
                    ),
                  ),
                ),

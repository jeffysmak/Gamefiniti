...
import 'package:indianapp/ui/dashboard/group/ViewImage.dart';
...
class ImageChatBubble extends StatelessWidget {
  ...
  ImageChatBubble({this.message, this.isMe, this.time, this.fromGroup});
                            ...
                            children: <Widget>[
                              ...
                              message.messageImage == null
                                  ...
                                  : GestureDetector(
                                      onTap: () {
                                        Navigator.push(
                                            context, MaterialPageRoute(builder: (ctx) => ViewImage(message)));
                                      },
                                      child: Image.network(
